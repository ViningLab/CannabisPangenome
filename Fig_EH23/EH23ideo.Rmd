...
ahplot + scale_color_brewer(palette="Paired", aes(alpha=0.04))
#  scale_color_manual( values = my_pal )

my_cols <- paste(RColorBrewer::brewer.pal(n=10, name = "Paired"), "04", sep = "")
ahplot + scale_color_manual( values = my_cols )
