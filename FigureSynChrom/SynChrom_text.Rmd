...
Alleles inherited through a single generation through a controlled cross, in a population of plants grown in a common garden, demonstrated random and nonrandom frequencies of inheritance.
...
Similarly, our random, or evolutionarily neutral, expectation is that these alleles will combine to form genotypes randomly to meet our Hardy-Weinberg expectation (heterozygous genotypes at a rate of 2pq = 0.5; *F~IS~* = 0).
