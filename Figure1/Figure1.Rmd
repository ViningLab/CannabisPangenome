...
## Primary supplemental PDF (figures and tables)

Please provide a single PDF that contains:

    All supplemental figures, titles, and legends
    Any supplemental table that can fit onto three 8.5" x 11" pages; also include titles for these tables, including "related to" information, in the PDF (legends are optional)
    Supplemental references

Please do not include the title or author list in the PDF; we will add a coversheet with this information.

The final size of the PDF can be up to 50 MB to accommodate high-resolution figures.
...
The *Cannabis sativa* L. genome has evolved with human culture as a source of food, fiber, and therapeutic oil.
